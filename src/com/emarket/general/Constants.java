...
public class Constants implements Serializable {
	...
	public static final EMarketException UNABLE_TO_UPLOAD_IMAGE = new EMarketException(
	...
	public static final EMarketException REQUEST_ALREADY_ACCEPTED = new EMarketException(REQUEST_ALREADY_ACCEPTED_MESSAGE);
	public static final String REQUEST_ALREADY_SENT_MESSAGE = "REQUEST_ALREADY_SENT_MESSAGE";
	public static final EMarketException REQUEST_ALREADY_SENT = new EMarketException(REQUEST_ALREADY_SENT_MESSAGE);
